...
export enum FeedErrorCode {
  ...
  SOCIAL_METRICS_FETCH_FAILED = 'SOCIAL_METRICS_FETCH_FAILED',
  LIKE_STATUS_FETCH_FAILED = 'LIKE_STATUS_FETCH_FAILED',
  FOLLOW_STATUS_FETCH_FAILED = 'FOLLOW_STATUS_FETCH_FAILED',
